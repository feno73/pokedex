...
var pokemons = 100;
var fetchDatos = function () {
    for (var i = 1; i <= pokemons; i++) {
        getPokemon(i);
    }
};
var getPokemon = function (id) { return __awaiter(void 0, void 0, void 0, function () {
    var datos, pokemon, pokemonTipo, transformarPokemon;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, fetch("https://pokeapi.co/api/v2/pokemon/" + id)];
            case 1:
                datos = _a.sent();
                return [4 /*yield*/, datos.json()];
            case 2:
                pokemon = _a.sent();
                pokemonTipo = pokemon.types.map(function (poke) { return poke.type.name; }).join(", ");
                transformarPokemon = {
                    id: pokemon.id,
                    nombre: pokemon.name,
...
var mostrarPokemon = function (pokemon) {
